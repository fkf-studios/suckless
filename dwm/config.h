...
static char normbordercolor[] = "#5af78e";
static char normfgcolor[] = "#bbbbbb";
static char selfgcolor[] = "#eeeeee";
static char selbordercolor[] = "#57c7ff";
...
static Key keys[] = {
    ...
    {MODKEY, XK_e, spawn, SHCMD("cat ~/scripts/dm-stuff | dmenu -l 30 | fish")},
    ...
    {MODKEY | ShiftMask, XK_p, spawn, SHCMD("archlinux-logout")},
     ...
     */
    {MODKEY, XK_d, spawn,
     SHCMD("rofi -show drun -theme "
           "~/polybar-themes/simple/forest/scripts/rofi/launcher.rasi")},
    ...
    {MODKEY | ShiftMask, XK_h, spawn, SHCMD("dm-hub")},
    ...
    {MODKEY, XK_m, spawn, SHCMD("fish -c ~/.music.sh")},
    ...
    {MODKEY, XK_F12, spawn,
     SHCMD(
         "remaps & notify-send \\\"⌨️ Keyboard remapping...\\\" \\\"Re-running "
    ...
    {MODKEY | ShiftMask, XK_Print, spawn, SHCMD("dm-record")},
